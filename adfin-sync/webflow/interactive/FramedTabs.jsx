/**
 * @generated
 * @file FramedTabs (generated by DevLink)
 *
...
export function FramedTabs({
  ...
  const _styleVariantMap = {
    ...
    Overlay: "w-variant-cd041697-6599-2ec1-23c5-3bc0e5db4090",
  };
  ...
  return (
    ...
    >
      {settingsVisibility && !slotIsEmpty(tabLink) ? (
        <Block
          className={`framed-tab_wrap ${_activeStyleVariant}`}
          id={settingsId}
          tag={"div"}
          {...{
        ...
        >
          <HtmlEmbed
            ...
            content={
              '<style>\n[data-tab="heading-wrap"]:not([data-preview="True"]) .framed-tab_heading,\n.framed-tab_content_list:not([data-preview="true"]) > :not(.w-dyn-list,.u-display-contents),\n.framed-tab_content_list:not([data-preview="true"]) > .w-dyn-list > * > * > *,\n.framed-tab_content_list:not([data-preview="true"]) > .u-display-contents > .w-dyn-list > * > * > *,\n.framed-tab_content_list:not([data-preview="true"]) > .u-display-contents > .u-display-contents > .w-dyn-list > * > * > *,\n.framed-tab_content_list:not([data-preview="true"]) > .u-display-contents > :not(.w-dyn-list,.u-display-contents),\n.framed-tab_content_list:not([data-preview="true"]) > .u-display-contents > .u-display-contents > :not(.w-dyn-list,.u-display-contents) {\n  display: none;\n}\n\n[data-tab="heading-wrap"] .framed-tab_heading:first-child,\n.framed-tab_content_list > :first-child:not(.w-dyn-list,.u-display-contents),\n.framed-tab_content_list > .w-dyn-list > * > :first-child > *,\n.framed-tab_content_list > .u-display-contents > .w-dyn-list > * > :first-child > *,\n.framed-tab_content_list > .u-display-contents > .u-display-contents > .w-dyn-list > * > :first-child > *,\n.framed-tab_content_list > .u-display-contents > :not(.w-dyn-list,.u-display-contents):first-child,\n.framed-tab_content_list > .u-display-contents > .u-display-contents > :not(.w-dyn-list,.u-display-contents):first-child {\n  display: block;\n}\n.wf-design-mode .framed-tab_button_list > :first-child:not(.w-dyn-list,.u-display-contents),\n.wf-design-mode .framed-tab_button_list > .w-dyn-list > * > :first-child > *,\n.wf-design-mode .framed-tab_button_list > .u-display-contents > :first-child:not(.w-dyn-list,.u-display-contents),\n.wf-design-mode .framed-tab_button_list > .u-display-contents > .u-display-contents > :first-child:not(.w-dyn-list,.u-display-contents),\n.wf-design-mode .framed-tab_button_list > .u-display-contents > .w-dyn-list > * > :first-child > *,\n.wf-design-mode .framed-tab_button_list > .u-display-contents > .u-display-contents > .w-dyn-list > * > :first-child > * {\n  --_state---true: 0;\n  --_state---false: 1;\n}\n.framed-tab_button_list:has([data-wf--tab-link--variant="link"]) { gap: 0rem; }\n</style>'
            }
          />
          <FrameLayout
            content={background}
            ...
            settingsVisibility={
              !slotIsEmpty(background) && variant === "Overlay" ? true : false
            }
          />
          <Block
            className={`framed-tab_header ${_activeStyleVariant}`}
            tag={"div"}
          >
            <FrameLayout
              content={
                <Layout
                  ...
                  column2={tabLink}
                  settingsClasses={
                    variant === "Overlay" ? "u-padding-inline-5" : ""
                  }
                  variant={
                    variant === "Overlay" ? "Columns Reversed" : "Auto Width"
                  }
                />
              }
              contentBorderBottom={variant !== "Overlay" ? true : false}
              contentPaddingTop={variant === "Overlay" ? "Small" : "Large"}
            />
          </Block>
          <FrameLayout
            content={
              <Block
                className={`framed-tab_right ${_activeStyleVariant}`}
                tag={"div"}
              >
                <Block
                  className={`framed-tab_content_wrap ${_activeStyleVariant}`}
                  tag={"div"}
                >
                  {tabContent}
                </Block>
                {settingsControls ? (
                  <Block
                    className={`framed-tab_control_wrap ${_activeStyleVariant}`}
                    tag={"div"}
                  >
                    <Block
                      className={`framed-tab_arrow_wrap ${_activeStyleVariant}`}
                      tag={"div"}
                    >
                      <ButtonArrow
                        arrowDirection={"Left"}
